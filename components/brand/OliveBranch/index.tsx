...
import styles from "./olivebranch.module.scss";
...
const OliveBranch: React.FC<OliveBranchProps> = ({ fill }) => {
 const oliveBranchClasses = cx({
  olivebranch: true,
  [`fill--${fill}`]: fill,
 });
 return (
