...
import InteractiveProcessModel, { type ProcessType } from "./InteractiveProcessModel";
import LeadershipVenn from "./LeadershipVenn";
...
function MarkedText({ text }: { text: string }) {
  return text.split(/([®™])/).map((part, index) =>
    part === "®" || part === "™" ? <sup className={styles.mark} key={`${part}-${index}`}>{part}</sup> : part,
  );
}
...
const services = [
  {
    ...
    detail: "Time Commitment: 3 to 6 months in person or virtual", processType: "coaching" as ProcessType,
  },
  {
    ...
    detail: "Time Commitment: 4-day off-site destination", processType: "jumpstart" as ProcessType,
  },
  {
    ...
    detail: "Time Commitment: 1-3 days for interviews, 2.5 days for retreat, up to 1 year for ongoing support", processType: "orgscan" as ProcessType,
  },
  {
    ...
    detail: "Time Commitment: One year", processType: "decathlon" as ProcessType,
  },
];
    ...
    <div className={styles.page}>
      <RevealSection className={styles.hero}>
        <div className={styles.heroInner}>
          ...
          <h1>We help leaders ease and speed <em>positive change<sup className={styles.mark}>™</sup></em></h1>
      ...
      <RevealSection className={styles.vennBreakout}>
        <div className={styles.vennIntro}>
          <p className={styles.sectionLabel}>Leadership</p>
          <h2>Leadership is the adaptive force of an organization.</h2>
          <p>Making leaders the levers or limiters of progress.</p>
        </div>
        <LeadershipVenn />
      </RevealSection>
      ...
      <RevealSection className={styles.services}>
        <header className={styles.servicesHeader}>
          ...
          <div className={styles.servicesIntroCopy}>
            <h2>Experiential interventions for leaders, teams, and the whole organization.</h2>
            <p>Each service moves beyond conventional training—combining experiential learning with focused intervention to support meaningful, lasting change.</p>
          </div>
        </header>
        {services.map((service) => (
          <RevealArticle className={styles.service} id={service.id} key={service.id}>
            <div className={styles.serviceHeading}>
              ...
              <p>{service.eyebrow}</p><h3><MarkedText text={service.name} /></h3>
            ...
            <div className={styles.processWrap}>
              ...
              <InteractiveProcessModel type={service.processType} />
            </div>
          </RevealArticle>
        ))}
      </RevealSection>
      ...
      <RevealSection className={styles.finalCta}>
        ...
        <h2>We help leaders ease and speed positive change<sup className={styles.mark}>™</sup> through tailored organizational development interventions.</h2>
